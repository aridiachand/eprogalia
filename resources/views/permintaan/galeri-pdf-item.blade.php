<!-- Modal -->
<div class="modal fade" id="modal-galeri-pdf-item" aria-labelledby="modal-formLabel" aria-hidden="true">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control spb_upload" id="spb_upload"
                                            disabled />
                                    </div>

                                    <div class="form-group col-md-4">
                                        <label for="kode_barang_upload" class="mb-md-0"><span>Kode Barang</span></label>
                                        <input type="text" class="form-control" id="kode_barang_upload" readonly />
                                    </div>

                                    <div class="form-group col-md-4">
                                        <label for="nama_barang_upload" class="mb-md-0"><span>Nama Barang</span></label>
                                        <input type="text" class="form-control nama_barang_upload"
                                            id="nama_barang_upload" readonly />
                                    </div>

                                    <input type="text" class="form-control idpermintaandetail"
                                        id="idpermintaandetail" hidden />
