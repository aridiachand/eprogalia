                    ...
                    <nav>
                        <div class="nav nav-tabs mb-3" id="nav-tab" role="tablist">
                            <button class="nav-link active" id="nav-all-tab" data-bs-toggle="tab" data-bs-target="#nav-all"
                                type="button" role="tab" aria-controls="nav-all" aria-selected="true">Verification
                                Vendor</button>
                        </div>
                    </nav>
                                ...
                                <table id="management_approve" class="table table-striped table-bordered">
                                    <thead class="bg-secondary">
                                        <tr>
                                            ...
                                            <th width="5%" class="text-white"><i class="fa fa-cog"></i></th>
                                        </tr>
                                    </thead>
                                    <tbody>
    ...
    <script>
        ...
        $(function() {
            table = $("#management_approve").DataTable({
                ...
                ajax: {
                    url: '{{ route('verification-vendor.data') }}',
                },
                columns: [{
                        data: 'DT_RowIndex',
                        searchable: false,
