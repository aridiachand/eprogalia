                    ...
                    <div class="card-body p-0 m-0">
                        <div class="table-responsive">
                                ...
                                @if (count($permintaandetail) > 0)
                                    @if ($pemilihanvendor)
                                        <tr class="mb-2" style="background:#37bcff;">
                                            <td class="text-white py-4">#</td>
                                            <td class="text-white py-4">Vendor</td>
                                            <td class="text-white py-4">Attachment</td>
                                            <td class="text-white py-4">Nilai (Rp)</td>
                                            <td class="text-white py-4">DP (%)</td>
                                            <td class="bg-success">
                                                <button
                                                    onClick="pilihVendorItem(`{{ $pd->id_permintaan_detail }}`, `{{ $pd->id_permintaan }}`, `{{ $pd->kode_barang }}`, `{{ $pd->nama_barang }}`)"
                                                    class="btn btn-success btn-xs btn-flat col-12"><i
                                                        class="mdi mdi-truck-delivery text-white fw-bold"
                                                        style="font-size: 18px;"></i>
                                                </button>
                                                {{-- <button
                                                    onClick="addNoteApprove(`{{ $pd->id_permintaan_detail }}`, `{{ $pd->id_permintaan }}`, `{{ $pd->kode_barang }}`, `{{ $pd->nama_barang }}`)"
                                                    class="btn btn-success btn-xs btn-flat"><i
                                                        class="mdi mdi-comment-plus-outline text-white fw-bold"
                                                        style="font-size: 14px;"></i>
                                                </button> --}}
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button
                                                    onClick="addNoteApprove(`{{ $pd->id_permintaan_detail }}`, `{{ $pd->id_permintaan }}`, `{{ $pd->kode_barang }}`, `{{ $pd->nama_barang }}`)"
                                                    class="btn btn-success btn-xs btn-flat"><i
                                                        class="mdi mdi-pencil text-white fw-bold"
                                                ...
                                                <button
                                                    ...
                                                    class="btn btn-danger btn-xs btn-flat"><i
                                                        class="mdi mdi-delete-forever text-white fw-bold"
                                                        style="font-size: 12px;"></i>
                                                </button>
                                            </td>
                                        </tr>
                            ...
                            @if ($pemilihanvendor->count() > 0)
                                <div class="p-2">
                                    <button id="saveAddVendor" class="btn btn-lg btn-success btn-flat col-md-2"><i
