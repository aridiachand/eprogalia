    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="box">
                        <button onclick="addForm('{{ route('vendor.store') }}')"
...
@push('scripts')
    ...
    <script>
        ...
        function addForm(url) {
            ...
            $('#modal-form form [name=nama_vendor]').val();
        }
        ...
        function editForm(url) {
            ...
            $.get(url)
                .done((response) => {
                    $('#modal-form form [name=nama_vendor]').val(response.nama_vendor);
                    $('#modal-form form [name=alamat_vendor]').val(response.alamat_vendor);
