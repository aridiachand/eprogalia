...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="box">
                        <button onclick="addForm('{{ route('kategori.detail.store') }}')"
    ...
    @includeIf('kategori.form-detail')
@endsection
    ...
    <script>
        ...
        $(function() {
            table = $("#zero_config").DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: '{{ route('kategori.detail.data') }}',
                },
                columns: [{
                        data: 'DT_RowIndex',
                        searchable: false,
        ...
        function addForm(url) {
            ...
            $('#modal-form .modal-title').text('Tambah Kategori Detail');
